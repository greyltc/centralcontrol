...
def get_args():
  ...
  parser.add_argument("--no-sweep", dest='sweep', action=StoreConst, const = False, help="Don't do an I-V sweep from Voc --> Jsc (the default)")
  parser.add_argument('--snaith', default=False, action=StoreConst, const = True, help="Do an I-V sweep from Jsc --> Voc")
  parser.add_argument("--no-snaith", dest='snaith', action=StoreConst, const = False, help="Don't do an I-V sweep from Jsc --> Voc (the default)")  
  parser.add_argument('--no-wavelabs', default=False, action=StoreConst, const = True, help="WaveLabs LED solar sim is not present")
  ...
  parser.add_argument('--t-prebias', type=float, action=RecordPref, default=10, help="Number of seconds to sit at initial voltage value before doing sweep")
  ...
  parser.add_argument("--t-dwell", type=float, action=RecordPref, default=15, help="Total number of seconds for the dwell mppt phase(s)")  
