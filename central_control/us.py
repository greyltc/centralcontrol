...
class us:
  ...
  protocol = 'us'
  steps_per_mm = 200*256/2.54
  current_position = None
  
  # in steps
  expected_length = [809219]  # number of entries here equals number of axes
  ...
  minimum_position = 5000 / steps_per_mm  #  in mm
  maximum_position = 330  # mm

  def __init__(self, address="us:///dev/ttyACM0"):
    """
